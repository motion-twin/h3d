...
class Demo extends flash.display.Sprite
{
	...
	function update() 
	{
		...
		if ( sceneTile == null) {
			...
			sceneDraw = new h2d.Bitmap(sceneTile );
			greyscale(sceneDraw);
			sceneDraw.filter = true;
			sceneDraw.scaleX = sceneDraw.scaleY = sc;
			sceneDraw.alpha = 0.5;
