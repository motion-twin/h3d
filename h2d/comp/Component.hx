...
class Component extends Sprite {
	...
	/**
	 * this is the style sheet generated byt the css engine, it will be overwritten fairly frequently so don't write in
	 * please use customStyle for this
	 */
	var style : h2d.css.Style;
	
	/**
	 * This is the writeable style sheed
	 */
